...
public interface GeometricShapeInterface {
	 ...
	 * @throws WrongNumberOfDimensionsException wyjątek zgłaszany, gdy
	 *     nowododawany
	 *                                          punkt posiada inną liczbę
	 * wymiarów niż te, które już wcześniej przed nim dodano. O poprawnej
	 * liczbie wymiarów decyduje <b>pierwszy</b> punkt dodany do kształtu.
	 */
	public void add(Point point) throws WrongNumberOfDimensionsException;

	/**
	 * Metoda usuwa punkt point, o ile taki istnieje. Jeśli w kolekcji punktów
	 * jest więcej takich samych jak point, usuwany jest tylko pierwszy z nich.
	 *
	 * @param point punkt do usunięcia
	 * @throws WrongArgumentException wyjątek zgłaszany gdy zlecane jest
	 *     usunięcie
	 ...
	 *                                          beforePoint przekazany został
	 * punkt, który nie został wcześniej dodany do figury.
	 * @throws WrongNumberOfDimensionsException wyjątek zgłaszany, gdy liczba
	 *                                          wymiarów punktu point lub
	 *                                          beforePoint nie jest zgodna z
	 * liczbą wymiarów punktów dodanych wcześniej do kształtu.
	 */
	 ...
	 * @throws WrongArgumentException           wyjątek zgłaszany, gdy jako
	 *                                          afterPoint przekazany został
	 * punkt, który nie został wcześniej dodany do figury.
	 * @throws WrongNumberOfDimensionsException wyjątek zgłaszany, gdy liczba
	 *                                          wymiarów punktu point lub
	 * afterPoint nie jest zgodna z liczbą wymiarów punktów dodanych wcześniej
	 * do kształtu.
	 */
	 ...
	 *                                          beforePoint jest pierwszym z
	 * punktów figury i innego punktu przed nim nie ma.
	 * @throws WrongArgumentException           wyjątek zgłaszany, gdy punkt
	 *                                          beforePoint nie został wcześniej
	 *                                          dodany do figury.
	 * @throws WrongNumberOfDimensionsException wyjątek zgłaszany, gdy liczba
	 *                                          wymiarów punktu beforePoint nie
	 * jest zgodna z liczbą wymiarów punktów dodanych wcześniej do kształtu.
	 */
	...
	/**
	 * Metoda zwraca zbiór punktów czyli kolekcję punktów bez powtórzeń.
	 * Kolejność punktów w tej kolekcji nie ma znaczenia. Powtórzenie punktu ma
	 * miejsce wtedy, gdy P1.equals(P2)=true.
	 *
	 ...
	 * którego współrzędne przekazywane są na liście positions. Jeśli istnieje
	 * wiele punktów o podanych wspołrzędnych zwracany jest punkt, który został
	 * dodany jako ostatni. Metoda nigdy nie może zakończyć się zwróceniem null,
	 * jeśli punktu o podanych współrzędnych nie ma, należy zwrócić pusty obiekt
	 * Optional.
	 *
	 * @param positions lista współrzędnych
	 * @return obiekt Optional zawierający (o ile istnieje) punkt, o
	 *     przekazanych za
	 *         pomocą positions współrzędnych, w przeciwnym wypadku pusty obiekt
	 *         Optional.
	 * @throws WrongNumberOfDimensionsException wyjątek zgłaszany, gdy rozmiar
	 *     listy
