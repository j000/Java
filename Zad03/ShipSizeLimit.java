...
public final class ShipSizeLimit {
	...
	/**
	 * Konstruktor, do którego przekazywana jest tablica zawierająca informacje
	 * o limicie ilości jednostek danego rozmiaru.
	 *
	 * @param shipSizes tablica z limitami ilości jednostek. Z uwagia na brak
	 *                  okrętów o rozmiarze 0, na pozycji shipSizes[x] znajduje
	 * się limit dla okrętów rozmiaru x+1.
	 */
	...
	/**
	 * Liczba różnych rozmiarów okrętów. Wynik zwrócony za pomocą
	 * getNumberOfSizes to jednocześnie rozmiar największej jednostki.
	 *
	...
	/**
	 * Maksymalna liczba okrętów o size rozmiarze. Dla size=0 metoda zawsze
	 * zwraca 0. Prawidłowe rozmiary okrętów mieszczą się w przedziale od 1 do
	 * getNumberOfSizes.
	 *
